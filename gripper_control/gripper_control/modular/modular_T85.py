...
class T85():
    ...
    def __user_data_to_motor(self, position):
        ...
        :return:
        """
        return  int(position * 4096 * 188 / 360)
    ...
    def open_gripper(self):
        configureData = b'\02\01\00\00\00\00'
        self.__node.sdo.download(0x2193, 0x01, configureData, True)
        self.__node.sdo.download(0x2193, 0x02, configureData, True)
        self.__node.sdo[0x2194].raw = 0x01
    ...
    def close_gripper(self):
        ...
        self.__node.sdo.download(0x2193, 0x01, configureData, True)
        self.__node.sdo.download(0x2193, 0x02, configureData, True)
        self.__node.sdo[0x2194].raw = 0x02

    def gripper_stop_motion(self):
        configureData = b'\02\01\00\00\00\00'
        self.__node.sdo.download(0x2193, 0x01, configureData, True)
        self.__node.sdo.download(0x2193, 0x02, configureData, True)
        self.__node.sdo[0x2194].raw = 0x00


    def read_gripper_state(self):
        return self.__node.sdo[0x2194].raw
